...
const games = [
  ...
  { id:'br14', name:'Gartic.io',         emoji:'✏️', platforms:['browser'], cat:'puzzle', catLabel:'Party / Dessin', desc:'Dessine et devine en ligne avec des milliers de joueurs.', url:'https://gartic.io', featured:false, tags:['dessin','party','multijoueur'] },
  { id:'br15', name:'Town of Salem',      emoji:'🕵️', platforms:['browser'], cat:'strategie', catLabel:'Mystère / Déduction', desc:'Jeu social de rôle en ligne où il faut démasquer les traîtres.', url:'https://www.blankmediagames.com/town-of-salem-2/', featured:false, tags:['deduction','social','stratégie'] },
  { id:'br16', name:'Bonk.io',            emoji:'⚽', platforms:['browser'], cat:'arcade', catLabel:'Arcade Multijoueur', desc:'Jeu de bataille multijoueur simple et addictif dans le navigateur.', url:'https://bonk.io', featured:false, tags:['arcade','multijoueur','party'] },
  { id:'br17', name:'Friday Night Funkin',emoji:'🎵', platforms:['browser'], cat:'rythme', catLabel:'Rythme', desc:'Rythme et battle musical gratuit jouable en ligne.', url:'https://ninja-muffin24.itch.io/funkin', featured:false, tags:['rythme','musique','browser'] },
  { id:'br18', name:'Realm of the Mad God',emoji:'👑', platforms:['browser'], cat:'mmo', catLabel:'MMO', desc:'Shoot & loot multijoueur avec pixel art et progression gratuite.', url:'https://www.realmofthemadgod.com', featured:false, tags:['mmo','coop','loot'] },
  { id:'br19', name:'Slay.one',           emoji:'🛡️', platforms:['browser'], cat:'fps', catLabel:'FPS', desc:'FPS multijoueur rétro jouable directement dans le navigateur.', url:'https://slay.one', featured:false, tags:['fps','multijoueur','browser'] },
  { id:'br20', name:'Doomed',             emoji:'👾', platforms:['browser'], cat:'arcade', catLabel:'Arcade', desc:'Plateformer shooter nerveux et gratuit en HTML5.', url:'https://doomed.app', featured:false, tags:['arcade','platformer','browser'] },
];

const EXTRA_FREE_GAMES = [
  { id:'pc22', name:'Destiny 2',         emoji:'🌌', platforms:['pc','xbox','playstation'], cat:'fps', catLabel:'FPS MMO', desc:'MMO shooter coop en ligne avec raids et contenus saisonniers.', url:'https://www.bungie.net/7/en/Destiny', featured:false, tags:['fps','mmo','coop'] },
  { id:'pc23', name:'Dauntless',         emoji:'🐉', platforms:['pc','xbox','playstation','switch'], cat:'action', catLabel:'Chasse aux monstres', desc:'Chasse au monstre free-to-play inspirée de Monster Hunter.', url:'https://playdauntless.com', featured:false, tags:['action','coop','hunt'] },
  { id:'pc24', name:'Roblox',            emoji:'🧱', platforms:['pc','mobile'], cat:'aventure', catLabel:'Création', desc:'Plateforme de jeux créés par des joueurs, gratuite et ouverte.', url:'https://www.roblox.com', featured:false, tags:['creation','social','sandbox'] },
  { id:'pc25', name:'War Thunder',        emoji:'✈️', platforms:['pc','xbox','playstation'], cat:'simulation', catLabel:'Simulateur militaire', desc:'Combat historique aérien, naval et terrestre gratuit.', url:'https://warthunder.com', featured:false, tags:['simulation','militaire','vehicules'] },
  { id:'pc26', name:'Hearthstone',       emoji:'🂡', platforms:['pc','mobile'], cat:'strategie', catLabel:'Cartes', desc:'Jeu de cartes stratégique Blizzard en free-to-play.', url:'https://playhearthstone.com', featured:false, tags:['cartes','strategie','tour par tour'] },
  { id:'pc27', name:'Teamfight Tactics', emoji:'♟️', platforms:['pc','mobile'], cat:'strategie', catLabel:'Auto Chess', desc:'Auto battler gratuit dans l’univers League of Legends.', url:'https://teamfighttactics.leagueoflegends.com', featured:false, tags:['auto battler','strategie','tactique'] },
  { id:'pc28', name:'Neverwinter',        emoji:'🗡️', platforms:['pc','xbox','playstation'], cat:'rpg', catLabel:'MMORPG', desc:'MMORPG Dungeons & Dragons gratuit avec quêtes et donjons.', url:'https://www.arcgames.com/en/games/neverwinter', featured:false, tags:['mmorpg','fantasy','donjon'] },
  { id:'pc29', name:'Trove',             emoji:'🧱', platforms:['pc','xbox','playstation'], cat:'aventure', catLabel:'Sandbox RPG', desc:'Aventure voxel free-to-play avec construction et loot.', url:'https://www.trionworlds.com/trove', featured:false, tags:['sandbox','mmo','voxel'] },
  { id:'pc30', name:'Marvel Snap',       emoji:'🃏', platforms:['pc','mobile'], cat:'cartes', catLabel:'Cartes', desc:'Jeu de cartes digital rapide avec héros Marvel.', url:'https://www.marvelsnap.com', featured:false, tags:['cartes','marvel','strategie'] },
  { id:'ps11', name:'Destiny 2',         emoji:'🌌', platforms:['pc','xbox','playstation'], cat:'fps', catLabel:'FPS MMO', desc:'MMO shooter coop en ligne disponible sur PS.', url:'https://www.bungie.net/7/en/Destiny', featured:false, tags:['fps','mmo','coop'] },
  { id:'ps12', name:'Dauntless',         emoji:'🐉', platforms:['pc','xbox','playstation','switch'], cat:'action', catLabel:'Chasse aux monstres', desc:'Chasse aux monstres en équipe avec équipement évolutif.', url:'https://playdauntless.com', featured:false, tags:['action','coop','hunt'] },
  { id:'ps13', name:'War Thunder',        emoji:'✈️', platforms:['pc','xbox','playstation'], cat:'simulation', catLabel:'Simulateur militaire', desc:'Combats aérien et blindés gratuits en ligne.', url:'https://warthunder.com', featured:false, tags:['simulation','militaire','vehicules'] },
  { id:'ps14', name:'Rocket League Sideswipe', emoji:'🚗', platforms:['mobile'], cat:'sport', catLabel:'Sport', desc:'Version gratuite mobile de Rocket League avec matchs rapides.', url:'https://www.rocketleague.com', featured:false, tags:['sport','mobile','voiture'] },
  { id:'xb09', name:'Destiny 2',         emoji:'🌌', platforms:['pc','xbox','playstation'], cat:'fps', catLabel:'FPS MMO', desc:'MMO shooter coop sur Xbox Series et One.', url:'https://www.bungie.net/7/en/Destiny', featured:false, tags:['fps','mmo','coop'] },
  { id:'xb10', name:'Dauntless',         emoji:'🐉', platforms:['pc','xbox','playstation','switch'], cat:'action', catLabel:'Chasse aux monstres', desc:'Jeu free-to-play de chasse aux monstres disponible sur Xbox.', url:'https://playdauntless.com', featured:false, tags:['action','coop','hunt'] },
  { id:'xb11', name:'Roblox',            emoji:'🧱', platforms:['pc','mobile'], cat:'aventure', catLabel:'Création', desc:'Plateforme de création et de jeux gratuits adaptée aux jeunes joueurs.', url:'https://www.roblox.com', featured:false, tags:['creation','social','sandbox'] },
  { id:'sw09', name:'Dauntless',         emoji:'🐉', platforms:['pc','xbox','playstation','switch'], cat:'action', catLabel:'Chasse aux monstres', desc:'Chasse aux monstres free-to-play sur Switch.', url:'https://playdauntless.com', featured:false, tags:['action','coop','hunt'] },
  { id:'sw10', name:'Pokémon Café ReMix',emoji:'☕', platforms:['switch','mobile'], cat:'puzzle', catLabel:'Puzzle', desc:'Jeu gratuit de gestion de café Pokémon.', url:'https://www.pokemon.com/us/pokemon-video-games/pokemon-cafe-remix/', featured:false, tags:['puzzle','pokemon','mobile'] },
  { id:'mb11', name:'Marvel Snap',       emoji:'🃏', platforms:['pc','mobile'], cat:'cartes', catLabel:'Cartes', desc:'Cartes rapides Marvel avec matchs gratuits.', url:'https://www.marvelsnap.com', featured:false, tags:['cartes','marvel','mobile'] },
  { id:'mb12', name:'Call of Duty Mobile', emoji:'📱', platforms:['mobile'], cat:'fps', catLabel:'FPS', desc:'FPS mobile gratuit avec modes multijoueur et battle royale.', url:'https://www.callofduty.com/mobile', featured:false, tags:['fps','mobile','battle royale'] },
  { id:'mb13', name:'Among Us',          emoji:'🛸', platforms:['mobile','pc'], cat:'aventure', catLabel:'Social', desc:'Jeu social de déduction gratuit sur mobile.', url:'https://www.innersloth.com/gameAmongUs.php', featured:false, tags:['social','deduction','multijoueur'] },
  { id:'br21', name:'Gartic Phone',      emoji:'📞', platforms:['browser'], cat:'party', catLabel:'Party', desc:'Jeu de dessin et telephone arabe en ligne gratuit.', url:'https://garticphone.com', featured:false, tags:['dessin','party','multijoueur'] },
  { id:'br22', name:'Skribbl.io',        emoji:'✏️', platforms:['browser'], cat:'party', catLabel:'Dessiner', desc:'Jeu de dessin style Pictionary dans le navigateur.', url:'https://skribbl.io', featured:false, tags:['dessin','party','browser'] },
  { id:'br23', name:'Venge.io',          emoji:'🧨', platforms:['browser'], cat:'fps', catLabel:'FPS', desc:'FPS rapide en ligne avec armes et arènes modernes.', url:'https://venge.io', featured:false, tags:['fps','browser','multijoueur'] },
  { id:'br24', name:'GeoGuessr Battle Royale', emoji:'🌍', platforms:['browser'], cat:'puzzle', catLabel:'Puzzle', desc:'Défi géographie gratuit dans le navigateur.', url:'https://www.geoguessr.com', featured:false, tags:['puzzle','geo','browser'] },
];
